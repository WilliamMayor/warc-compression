"""
Removes ten character blocks at random from the file 100 times
"""
import os
import sys
...
def factory_factory(base_path, data_path):
    def g():
        ...
        for i in xrange(0, 20):
            previous = modifiers.delete(previous, 10)
...
if __name__ == '__main__':
    ...
    data_dir = os.path.join(base_text_dir, 'ten_char_delete')
    try:
        os.mkdir(data_dir)
    except OSError:
