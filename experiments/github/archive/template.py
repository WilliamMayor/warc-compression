...
metadata.operatorContactUrl=http://www0.cs.ucl.ac.uk/people/W.Mayor.html
metadata.jobName=compression-experiment
metadata.description=Archive of github.io projects used to evaluate compression techniques for WARC archives.

disposition.delayFactor=0

frontier.retryDelaySeconds=1
frontier.maxRetries=10
frontier.extract404s=true
  ...
  <property name="rules">
   <list>
    ...
    <bean class="org.archive.modules.deciderules.NotMatchesListRegexDecideRule">
          ...
          <property name="regexList">
           <list>
            <value>^http://localhost:WC_PORT.*</value>
           </list>
          </property>
    </bean>
